...
def run_blast_and_get_evalue(primer_sequence, db_path):
    ...
    rc_primer_sequence = get_reverse_complement(cleaned_seq)
    ...
    # Write the reverse complement sequence to a temporary file
    ...
    try:
        ...
        cmd = [
            ...
            "-word_size", "15",       # Decrease word size for increased sensitivity
